...
public class ModRegistry {
    ...
    public static final RegistryReference<Item> HANG_GLIDER_ITEM  = REGISTRY.registerItem("hang_glider", () -> new Item(new Item.Properties().durability(818).tab(OPEN_GLIDER_TAB)));
    public static final RegistryReference<Item> REINFORCED_HANG_GLIDER_ITEM  = REGISTRY.registerItem("reinforced_hang_glider", () -> new Item(new Item.Properties().durability(2202).tab(OPEN_GLIDER_TAB).rarity(Rarity.UNCOMMON)));

    private static final CapabilityController CAPABILITIES = CoreServices.FACTORIES.capabilities(OpenGlider.MOD_ID);
    public static final CapabilityKey<GlidingPlayerCapability> GLIDING_PLAYER_CAPABILITY = CAPABILITIES.registerPlayerCapability("gliding_player", GlidingPlayerCapability.class, entity -> new GlidingPlayerCapabilityImpl(), PlayerRespawnStrategy.LOSSLESS);
